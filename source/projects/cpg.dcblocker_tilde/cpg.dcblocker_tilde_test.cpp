...
#include "cpg.dcblocker_tilde.cpp"	// need the source of our object so that we can access it
...
TEST_CASE( "produces valid impulse response" ) {
	...
	test_wrapper<dcblocker> an_instance;
	dcblocker& my_object = an_instance;
